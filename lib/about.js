define(function () {
  return function() {
    this.render = function (d) {
      ...
      s += "<p>You may find ffnord's source code at "
      s += "<a href=\"https://github.com/ffnord/meshviewer\">"
      s += "https://github.com/ffnord/meshviewer</a>.</p>"

      s += "<p>This Meshviewer is a fork of ffmwu at "
      s += "<a href=\"https://github.com/freifunk-mwu/meshviewer\">"
      s += "https://github.com/freifunk-mwu/meshviewer</a> and is customized for ffwp at "
      s += "<a href=\"https://github.com/freifunk-westpfalz/meshviewer\">"
      s += "https://github.com/freifunk-westpfalz/meshviewer</a>."
